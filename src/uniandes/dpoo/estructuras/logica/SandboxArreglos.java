...
public class SandboxArreglos {
	...
	public void agregarEntero(int entero) {
		int[] arregloMayor = new int[arregloEnteros.length + 1];
		for (int i = 0; i < arregloEnteros.length; i++) {
			arregloMayor[i] = arregloEnteros[i];
		}
		arregloMayor[arregloMayor.length - 1] = entero;
		arregloEnteros = arregloMayor;
	}
	...
	public void agregarCadena(String cadena) {
		String[] arregloMayor = new String[arregloCadenas.length + 1];
		for (int i = 0; i < arregloCadenas.length; i++) {
			arregloMayor[i] = arregloCadenas[i];
		}
		arregloMayor[arregloMayor.length - 1] = cadena;
		arregloCadenas = arregloMayor;
	}
	...
	public void eliminarEntero(int valor) {
		...
		for (int i = 0; i < arregloEnteros.length; i++) {
			if (arregloEnteros[i] != valor) {
				nuevoArreglo[pos] = arregloEnteros[i];
				pos++;
			}
		}
	...
	public void eliminarCadena(String cadena) {
		...
		for (int i = 0; i < arregloCadenas.length; i++) {
			if (!arregloCadenas[i].equals(cadena)) {
				nuevoArreglo[pos] = arregloCadenas[i];
				pos++;
			}
		}
	...
	public boolean mismosEnteros(int[] otroArreglo) {
		...
		for (int i = 0; i < arregloEnteros.length; i++) {
			...
			for (int k = 0; k < otroArreglo.length; k++) {
				if (otroArreglo[k] == valor) {
					contadorOtro++;
				}
			}
			if (contadorPropio != contadorOtro) {
				return false;
			}
		}
		return true;
